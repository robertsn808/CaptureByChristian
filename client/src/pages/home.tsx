        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <p className="text-white/70">{profile?.phone || "(808) 203-8455"}</p>
            </div>
            <div className="text-center">
              <div className="bg-bronze rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center">
              ...
              <p className="text-white/70">{profile?.email || "christian@falonzophotography.com"}</p>
            </div>
            <div className="text-center">
              <div className="bg-bronze rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="font-playfair text-2xl font-bold mb-4 flex items-center text-[#f5f5f5]">
                ...
                <Link href="/admin-login" className="hover:text-bronze transition-colors duration-200">
          ...
          <div className="border-t border-[#f5f5f5]/20 mt-8 pt-8 text-center text-[#f5f5f5]/80 relative">
            <p className="mb-2 text-[#f5f5f5]/80">
              &copy; 2024 {profile?.name || "Christian Falonzo Photography"}. All rights reserved. | Licensed Drone Operator | AI-Enhanced Media
            </p>
