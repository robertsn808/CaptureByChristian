    ...
    const predictiveModels: PredictionModel[] = [
      {
        ...
        recommendation:
          bookingsData.length > 0
            ? "Focus on converting pending bookings to increase revenue"
            : "Generate more leads to build predictive accuracy",
      },
      {
        ...
        recommendation:
          bookingsData.length > 5
            ? "Scale operations to handle increased demand"
            : "Focus on lead generation and client acquisition",
      },
      {
        ...
        recommendation:
          bookingsData.length > 0
            ? "Focus on increasing repeat booking frequency"
            : "Establish baseline client value metrics",
      },
      {
        ...
        recommendation:
          totalRevenue > 2000
            ? "Focus on scaling current successful services"
            : "Build market presence through consistent service delivery",
      },
      {
        ...
        recommendation:
          confirmedBookings > 2
            ...
            : "Focus on improving lead response time and follow-up processes",
      },
    ];
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            AI-powered forecasting and strategic insights
          </p>
        </div>
        ...
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              Analyzing market data, booking patterns, and business
              performance...
            </p>
