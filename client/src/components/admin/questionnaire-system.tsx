...
export function QuestionnaireSystem() {
  ...
  const questionnaires = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          type: "textarea",
          question:
            "Any family dynamics or sensitivities we should know about?",
          required: false,
        },
        {
          id: "drone_coverage",
  ...
  const questionnaireStats = {
    ...
    avgCompletion: Math.round(
      questionnaires.reduce((sum, q) => sum + q.completionRate, 0) /
  ...
  return (
    <div className="space-y-6">
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-2xl font-bold">
                  {questionnaireStats.totalResponses}
                </p>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-2xl font-bold">
                  {questionnaireStats.avgCompletion}%
                </p>
        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            ...
            <div className="flex space-x-2">
              <Button
                variant="outline"
                onClick={() => setQuestionnaireBuilder(true)}
              >
              ...
              <Button
                ...
                onClick={() => setNewQuestionnaireOpen(true)}
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <Badge
                        variant={questionnaire.active ? "default" : "secondary"}
                      >
                        ...
                        <div className="space-y-1 text-sm">
                          {Object.entries(response.responses)
                            ...
                            .map(([key, value]) => (
                              <div key={key} className="flex">
                                <span className="text-muted-foreground w-32 capitalize">
                                  {key.replace(/_/g, " ")}:
                                </span>
                          ...
                          {Object.keys(response.responses).length > 3 && (
                            <div className="text-bronze text-sm">
                              +{Object.keys(response.responses).length - 3} more
                              responses
                            </div>
                          )}
                        </div>
      ...
      <Dialog
        ...
        onOpenChange={setNewQuestionnaireOpen}
      >
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>Create New Questionnaire</DialogTitle>
            <DialogDescription>
              Create custom questionnaires for different photography services
              and client types.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            ...
            <div className="flex justify-end space-x-2">
              ...
              <Button className="btn-bronze">Create & Add Questions</Button>
            </div>
          </div>
        </DialogContent>
      </Dialog>
      ...
      <Dialog
        open={questionnaireBuilder}
        onOpenChange={setQuestionnaireBuilder}
      >
        <DialogContent className="max-w-4xl">
          ...
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-6">
              Drag-and-drop question builder with conditional logic, file
              uploads, and smart validation
            </p>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="p-4 border rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  Text, date, select, multi-select, file upload
                </p>
              </div>
              <div className="p-4 border rounded-lg">
