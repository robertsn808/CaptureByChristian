...
export function Hero() {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden" style={{ width: '100vw', marginLeft: '50%', transform: 'translateX(-50%)' }}>
      {/* Video Background */}
        ...
        <div className="text-center text-white px-6 animate-fade-in max-w-5xl">
          ...
          <div className="flex items-center justify-center mb-8">
            <div className="bg-gradient-to-r from-bronze/20 to-teal/20 backdrop-blur-sm border border-white/20 rounded-full px-6 py-3 flex items-center space-x-3">
              ...
              <span className="text-lg font-medium text-white/90">Christian Falonzo Photography</span>
