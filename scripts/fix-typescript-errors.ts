 ...
 * 
 * Run with: npx ts-node scripts/fix-typescript-errors.ts
 */
...
const FIXES = [
  ...
  // Fix null/undefined values in form fields
  {
    pattern: /value={field\.value}/g,
    replacement: 'value={field.value || \'\'}',
    description: 'Handle null/undefined form field values'
  },
  
  // Fix defaultValue in Select components
  {
    pattern: /defaultValue={field\.value}/g,
    replacement: 'defaultValue={field.value || undefined}',
    description: 'Handle null/undefined default values'
  }
];
...
function applyFixes(filePath: string): { fixed: boolean; changes: string[] } {
